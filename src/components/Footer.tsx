...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-center gap-4 self-center rounded-t-2xl px-8 pt-2 pb-4 text-base dark:bg-slate-800/80 sm:gap-6 sm:pt-4 sm:pb-6 sm:text-xl">
